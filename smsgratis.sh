...
# Phreaker SUMATERA : https://t.me/joinchat/LQvRmkgX6aA7RLcURwvfgQ
# By. BangNAGA
...
############################################# 
 ______  _                     _                
(_____ \| |                   | |               
 _____) ) | _   ____ ____ ____| |  _ ____  ____ 
|  ____/| || \ / ___) _  ) _  | | / ) _  )/ ___)
| |     | | | | |  ( (/ ( ( | | |< ( (/ /| |    
|_|     |_| |_|_|   \____)_||_|_| \_)____)_|    
                                                                        ${CYAN}[^]SMS GRATIS[^]${GREEN}
#############################################
"
...
function negetgan(){
         ...
         if [[ $okeey =~ "SMS Gratis Telah Dikirim" ]]; then
             echo -e "${GREEN}[+] ${NORMAL}Pesan Terkirim"
         else
             echo -e "${RED}[+] ${NORMAL}Pesan Gagal Terkirim"
         fi
}
nebanner
